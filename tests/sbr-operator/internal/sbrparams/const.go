...
const (
	...
	// SBRCNoMatchSelectorTestName is the name used for StorageBasedRemediationConfig CRs testing non-matching nodeSelector handling.
	...
	// SBRCNoMatchSelectorKey is the node label key used to create a StorageBasedRemediationConfig nodeSelector that matches no nodes.
	SBRCNoMatchSelectorKey = "sbr-test-no-match-selector"

	// SBRCNoMatchSelectorValue is the node label value used to create a StorageBasedRemediationConfig nodeSelector that matches no nodes.
